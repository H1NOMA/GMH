...
Скриншоты снимайте в реальном приложении: тёмная тема + фэнтези-мир,
светлая тема, киберпанк-мир, профиль персонажа, граф связей, конструктор
разделов — этого хватит на 6 сильных кадров. На каждом языке страницы можно
загрузить локализованные скриншоты, но это опционально.
