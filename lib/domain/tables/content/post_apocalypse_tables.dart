...
const postApocalypseTables = <LibraryTable>[
  LibraryTable(
    ...
    formula: '2d6',
    name: Tx('Wasteland Encounters', 'Встречи в пустошах',
        'Begegnungen im Ödland', 'Rencontres des terres désolées', '废土遭遇'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d10',
    name: Tx('Campfire Rumors', 'Слухи у костра', 'Gerüchte am Lagerfeuer',
        'Rumeurs de bivouac', '篝火传闻'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d10',
    name: Tx('Wasteland Hazards', 'Опасности пустошей', 'Gefahren des Ödlands',
        'Dangers des terres désolées', '废土险情'),
    description: Tx(
  ...
  LibraryTable(
    ...
    name: Tx('Survivor Quirks', 'Причуды выживших', 'Marotten von Überlebenden',
        'Manies de survivants', '幸存者怪癖'),
    description: Tx(
