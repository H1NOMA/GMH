...
const wildWestTables = <LibraryTable>[
  LibraryTable(
    ...
    formula: '1d12',
    name: Tx('Trail Encounters', 'Встречи на тропе', 'Begegnungen auf dem Trail',
        'Rencontres sur la piste', '小道遭遇'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '2d6',
    name: Tx('Frontier Trouble', 'Беды фронтира', 'Ärger an der Grenze',
        'Ennuis de la frontière', '边疆麻烦'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d10',
    name: Tx('Saloon Talk', 'Разговоры в салуне', 'Saloongerede',
        'Bavardages de saloon', '酒馆闲谈'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d20',
    name: Tx('Saddlebag Finds', 'Находки в седельных сумках',
        'Funde in Satteltaschen', 'Trouvailles de sacoches', '鞍袋里的发现'),
    description: Tx(
  ...
  LibraryTable(
    ...
    name: Tx('Frontier Characters', 'Люди фронтира', 'Grenzland-Gestalten',
        'Figures de la frontière', '边疆人物'),
    description: Tx(
