...
const steampunkTables = <LibraryTable>[
  LibraryTable(
    ...
    formula: '1d12',
    name: Tx('Cobblestone Encounters', 'Встречи на мостовой',
        'Begegnungen auf dem Pflaster', 'Rencontres sur les pavés', '石板街遭遇'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d10',
    name: Tx('Contraptions Gone Wrong', 'Механизмы вразнос',
        'Apparate außer Kontrolle', 'Machines déréglées', '失控的奇巧装置'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d10',
    name: Tx('Salon Gossip', 'Салонные сплетни', 'Salonklatsch',
        'Potins de salon', '沙龙八卦'),
    description: Tx(
  ...
  LibraryTable(
    ...
    formula: '1d20',
    name: Tx('Inventor\'s Pockets', 'Карманы изобретателя',
        'Erfindertaschen', 'Poches d\'inventeur', '发明家的口袋'),
    description: Tx(
  ...
  LibraryTable(
    ...
    name: Tx('Eccentric Quirks', 'Чудачества', 'Exzentrische Marotten',
        'Excentricités', '古怪癖好'),
    description: Tx(
