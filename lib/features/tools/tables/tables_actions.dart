...
final worldTablesProvider = Provider.autoDispose
  ...
  return ref
      ...
      .whenData((objects) => [for (final o in objects) RandomTable.fromObject(o)]);
});
...
class TablesActions {
  ...
  Future<List<RandomTable>> addFromLibrary(
      String worldId, List<LibraryTable> tables, String lang) async {
...
List<LibraryTable> missingDependencies(
    LibraryTable table, List<RandomTable> worldTables, String lang) {
