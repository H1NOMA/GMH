...
abstract class AppLocalizations {
  ...
  /// No description provided for @editWorldTitle.
  ///
  /// In en, this message translates to:
  /// **'Edit world'**
  String get editWorldTitle;

  /// No description provided for @worldActions.
  ///
  /// In en, this message translates to:
  /// **'World actions'**
  String get worldActions;
  ...
  /// No description provided for @worldSection.
  ///
  /// In en, this message translates to:
  /// **'World'**
